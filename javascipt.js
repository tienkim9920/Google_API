$(function () {
  var origin, destination, map;
    ...
    function appendResults(distance_in_kilo, distance_in_mile, duration_text) {
        ...
        $('#in_kilo').html("Kilo : <span class='badge badge-pill badge-secondary'>" + distance_in_kilo.toFixed(2) + "</span>");
        $('#duration_text').html("Duration Text: <span class='badge badge-pill badge-success'>" + duration_text + "</span>");
    }
